  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-cover bg-gray-900 p-4 text-white">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <GameCard title="Slots" description="Try your luck at our themed slot machines." image="/images/slot_card_image.png" />
        <GameCard title="BlackJack" description="Beat the dealer to 21 in our Blackjack game." image="/images/blackjack_card_image.png" />
        <GameCard title="Poker" description="Join the table in our high-stakes Poker games." image="/images/poker_card_image.png" />
        <GameCard title="Coin Flipping" description="A quick flip can double your stakes or more." image="/images/coin_card_image.png" />
        <GameCard title="Roulette" description="Place your bets on our Roulette wheel." image="/images/roulette_card_image.png" />
      </section>
